...
const asiRoutes = require('./src/routes/asiRoutes');
...
app.use(cors({
    origin: function (origin, callback) {
        let frontendUrls = (process.env.FRONTEND_URL || 'http://localhost:5173').split(',');
...
// Routes
app.use('/api', asiRoutes); // New ASI-1 API Endpoints representing the entire backend
